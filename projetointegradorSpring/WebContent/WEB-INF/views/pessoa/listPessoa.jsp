		...
		<table class="table table-striped" id="lista">
			...
			<c:forEach items="${pessoas}" var="pessoa">
				<tr>
					...
					<td><a href='${pageContext.request.contextPath}/editPessoa?id=${pessoa.id}'><span class="glyphicon glyphicon-pencil"></span></a></td>
					<td><a href="#" onclick="javascript:excluiRegistro(${pessoa.id});"><span class="glyphicon glyphicon-remove"></span></a></td>
				</tr>
			</c:forEach>
		</table>
		<br><br>
		<button type="button" class="btn btn-primary" onclick="javascript:window.location.href='${pageContext.request.contextPath}/formPessoa'"><fmt:message key="pessoa.button.cadastrar"/></button>
		
		<!-- Modal excluir -->
		<form:form action="${pageContext.request.contextPath}/pessoa/delete" method="post">
