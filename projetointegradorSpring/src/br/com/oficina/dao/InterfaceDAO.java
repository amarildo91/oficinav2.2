...
public interface InterfaceDAO<T> {
	 ...
	 * @throws Exception Possível exceção gerada ao realizar a operação.
	 */
	public List<T> getInstanciasList(String atributoOrdem) throws Exception;
	 ...
	 * @throws Exception Possível exceção gerada ao realizar a operação.
	 */    
	public List<T> getInstanciasList(String atributoOrdem, String atributoFiltro, String valorFiltro) throws Exception;
	 ...
	 * @throws Exception Possível exceção gerada ao realizar a operação.
	 */    
	public List<T> getInstanciasList(String atributoOrdem, String atributoFiltro, String valorFiltro, Integer quantidade, Integer posicaoInicial) throws Exception;
