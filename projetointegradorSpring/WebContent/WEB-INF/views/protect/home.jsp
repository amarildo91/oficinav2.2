...
<tag:template id="text" name="text" title="Home">
	<jsp:attribute name="divBody">
		<script>
			...
			function excluir(){
				window.location="${pageContext.request.contextPath}/protect/home/delete?id="+$("#idCompromissoExclud").val();
		...
		<button type="button" class="btn btn-default" onclick="window.location='${pageContext.request.contextPath}/protect/home/listaTodos'"><fmt:message key="home.button.listarTodos"/></button>
		
		<!-- Modal agendamento de compromissos -->
		<form:form action="${pageContext.request.contextPath}/protect/agendarCompromisso" method="post">
		...
		<!-- Modal edit -->
		<form:form action="${pageContext.request.contextPath}/protect/editarCompromisso" method="post">
		...
		<!-- Modal excluir -->
		<form:form action="${pageContext.request.contextPath}/protect/home/delete" method="post">
