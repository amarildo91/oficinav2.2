...
public class PessoaController {
	...
	public ModelAndView begin(@RequestParam(required=false) boolean successMessage, @RequestParam(required=false) boolean insert){
		...
		ModelAndView model = new ModelAndView("protect/pessoa/listPessoa");
	...
	@RequestMapping("/protect/formPessoa")
	public ModelAndView formPessoa(){
		System.out.println("formPessoa() - enter");
		
		ModelAndView model = new ModelAndView("protect/pessoa/formPessoa", "pessoa", new Pessoa());
		model.addObject("cidades", pessoaModel.listCidade());
		return model;
	}
	
	@RequestMapping(value="/protect/cadastrarPessoa", method=RequestMethod.POST)
	public String cadastrarPessoa(@Valid Pessoa pessoa, @Valid Endereco endereco){
		...
		return "redirect:/protect/pessoa?insert=true&successMessage="+success;
	}
	
	@RequestMapping(value="/protect/editPessoa", method=RequestMethod.GET)
	public ModelAndView editPessoa(@RequestParam("id") String id){
		System.out.println("editPessoa(String id) - enter");
		
		ModelAndView model = new ModelAndView("protect/pessoa/formPessoa");
	...
	@RequestMapping(value="/protect/editPessoaSubmit", method=RequestMethod.POST)
	public String editPessoaSubmit(@Valid Pessoa pessoa, @Valid Endereco endereco, @RequestParam("idPessoa") String idPessoa,@RequestParam("idEndereco") String idEndereco){
		...
		return "redirect:/protect/pessoa?insert=true&successMessage="+update;
	}	
	
	@RequestMapping(value="/protect/pessoa/delete", method=RequestMethod.POST)
