...
<tag:template id="text" name="text" title="Ordem de Serviço">
	<jsp:attribute name="divBody">
		...
		<c:set var="acao" value="${pageContext.request.contextPath}/protect/cadastrarOrdemServico"/>
		<c:if test="${ordemServico.idOrdemServico gt 0}">
			<c:set var="acao" value="${pageContext.request.contextPath}/protect/editOrdemServicoSubmit"/>			
		</c:if>
		...
		<form:form action="${pageContext.request.contextPath}/protect/deletarItem" method="post">
