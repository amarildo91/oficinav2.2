...
<tag:template id="text" name="text" title="Cadastro Produtos">
	<jsp:attribute name="divBody">
		...
		<!-- Modal insert -->
		<form:form action="${pageContext.request.contextPath}/cadastrarProduto" method="post">
		...
		<!-- Modal edit -->
		<form:form action="${pageContext.request.contextPath}/editProduto" method="post">
		...
		<!-- Modal excluir -->
		<form:form action="${pageContext.request.contextPath}/produto/delete" method="post">
