...
<tag:template id="text" name="text" title="Cadastro Cidade">
	<jsp:attribute name="divBody">
		...
		<table class="table table-striped">
			<tr>
				<td><b><fmt:message key="cidade.nome"/></b></td>
				<td><b><fmt:message key="cidade.uf"/></b></td>
				<td></td><td></td>
			</tr>
		...
		<!-- Modal insert -->
		<form:form action="${pageContext.request.contextPath}/cadastrarCidade" method="post" modelAttribute="cidade">
		...
		<!-- Modal edit -->
		<form:form action="${pageContext.request.contextPath}/editarCidade" method="post">
		...
		<!-- Modal excluir -->
		<form:form action="${pageContext.request.contextPath}/cidade/delete" method="post">
